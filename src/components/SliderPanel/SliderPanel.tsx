...
export function SliderPanel() {
  ...
  return (
    <div className="space-y-3 p-4 rounded-xl bg-white/90 dark:bg-surface-card/90 backdrop-blur border border-gray-200 dark:border-white/10 shadow-lg">
      ...
      {params.map((param) => (
        <div key={param.name} className="space-y-1">
          <div className="flex justify-between text-xs">
            <span className="font-mono font-bold text-neon-blue">{param.name}</span>
          ...
          <input
            ...
            className="w-full h-1.5 bg-gray-200 dark:bg-white/10 rounded-full appearance-none cursor-pointer accent-neon-blue"
          />
